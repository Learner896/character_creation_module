...
class Character:
    ...
    BRIEF_DESC_CHAR_CLASS = 'отвыжный любитель приключений'
...
def attack(char_name: str, char_class: str) -> str:
    """Randomise damage dealt by player."""
...
def defence(char_name: str, char_class: str) -> str:
    """Randomise damage blocked by player."""
    if char_class == 'warrior':
    ...
    return ('Не заблокировал урон')


def special(char_name: str, char_class: str) -> str:
    """USe special abilities of a class."""
    if char_class == 'warrior':
    ...
    while approve_choice != 'y':
        ...
        if char_class == 'warrior':
            print('Воитель — дерзкий воин ближнего боя. Сильный, выносливый '
                  'и отважный.')
        if char_class == 'mage':
            print('Маг — находчивый воин дальнего боя. Облад'
                  'ает высоким интелле'
                  'ктом.')
        if char_class == 'healer':
